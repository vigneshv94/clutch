...
const (
	TrafficType_TRAFFICTYPE_UNSPECIFIED TrafficType = 0
	// Apply faults on ingress trafic coming to an upstream cluster.
	TrafficType_TRAFFICTYPE_INGRESS TrafficType = 1
	// Apply faults on egress trafic coming out of a downstream cluster.
	TrafficType_TRAFFICTYPE_EGRESS TrafficType = 2
)

// Enum value maps for TrafficType.
var (
	TrafficType_name = map[int32]string{
		0: "TRAFFICTYPE_UNSPECIFIED",
		1: "TRAFFICTYPE_INGRESS",
		2: "TRAFFICTYPE_EGRESS",
	}
...
type TestConfig struct {
	...
	//	*TestConfig_ClusterPair
	Target isTestConfig_Target `protobuf_oneof:"target"`
	...
	TrafficType TrafficType `protobuf:"varint,4,opt,name=traffic_type,json=trafficType,proto3,enum=clutch.chaos.serverexperimentation.v1.TrafficType" json:"traffic_type,omitempty"`
}
...
func (m *TestConfig) GetTarget() isTestConfig_Target {
	if m != nil {
		return m.Target
	}
	return nil
...
func (x *TestConfig) GetClusterPair() *ClusterPairTarget {
	if x, ok := x.GetTarget().(*TestConfig_ClusterPair); ok {
...
func (x *TestConfig) GetTrafficType() TrafficType {
	if x != nil {
		return x.TrafficType
	}
	return TrafficType_TRAFFICTYPE_UNSPECIFIED
}

type isTestConfig_Target interface {
	isTestConfig_Target()
}

type TestConfig_ClusterPair struct {
	ClusterPair *ClusterPairTarget `protobuf:"bytes,1,opt,name=cluster_pair,json=clusterPair,proto3,oneof"`
}

func (*TestConfig_ClusterPair) isTestConfig_Target() {}
...
var file_chaos_serverexperimentation_v1_serverexperimentation_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0xfd, 0x02, 0x0a, 0x0a, 0x54, 0x65, 0x73, 0x74, 0x43, 0x6f, 0x6e,
	0x66, 0x69, 0x67, 0x12, 0x5d, 0x0a, 0x0c, 0x63, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x5f, 0x70,
	...
	0x67, 0x65, 0x74, 0x48, 0x00, 0x52, 0x0b, 0x63, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x50, 0x61,
	...
	0x61, 0x75, 0x6c, 0x74, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x48, 0x01, 0x52, 0x05, 0x61, 0x62,
	...
	,
...
var file_chaos_serverexperimentation_v1_serverexperimentation_proto_goTypes = []interface{}{
	(TrafficType)(0),           // 0: clutch.chaos.serverexperimentation.v1.TrafficType
...
var file_chaos_serverexperimentation_v1_serverexperimentation_proto_depIdxs = []int32{
	...
	0, // 3: clutch.chaos.serverexperimentation.v1.TestConfig.traffic_type:type_name -> clutch.chaos.serverexperimentation.v1.TrafficType
